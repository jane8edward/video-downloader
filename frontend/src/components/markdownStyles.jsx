...
export const markdownComponents = {
  h1: ({ children }) => (
    <h1 className="text-2xl font-bold text-white mb-4 mt-1 leading-tight">{children}</h1>
  ),
  h2: ({ children }) => (
    <h2 className="text-xl font-semibold text-white mb-3 mt-6 leading-tight">{children}</h2>
  ),
  h3: ({ children }) => (
    <h3 className="text-lg font-semibold text-white mb-2 mt-5 leading-snug">{children}</h3>
  ),
  h4: ({ children }) => (
    <h4 className="text-base font-semibold text-gray-200 mb-2 mt-4 leading-snug">{children}</h4>
  ),
  p: ({ children }) => (
    <p className="text-gray-300 mb-4 leading-8 break-words">{children}</p>
  ),
  ul: ({ children }) => (
  ...
  li: ({ children }) => <li className="text-gray-300 leading-8 pl-1 break-words">{children}</li>,
  strong: ({ children }) => (
